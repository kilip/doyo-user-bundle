...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator([($this->targetDirs[4].'/src/Resources/config/doctrine-mapping') => 'Doyo\\UserBundle\\Model'], '.orm.xml')), 'Doyo\\UserBundle\\Model');
