...
class __TwigTemplate_f3cf1f8f4efbbce0580ecdbd276c3eea60342cb9d54b2cb865346df0f0f78a5e extends \Twig\Template
{
    private $source;
    ...
    ';
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 6, $this->source); })()), 'messageCount', [], 'any', false, false, false, 6)) {
            ...
            // line 8
            echo '            ';
            if ((1 === (isset($context['profiler_markup_version']) || array_key_exists('profiler_markup_version', $context) ? $context['profiler_markup_version'] : (function () { throw new RuntimeError('Variable "profiler_markup_version" does not exist.', 8, $this->source); })()))) {
                // line 9
        ...
        ';
            ...
            ';
            // line 23
            if ((1 === (isset($context['profiler_markup_version']) || array_key_exists('profiler_markup_version', $context) ? $context['profiler_markup_version'] : (function () { throw new RuntimeError('Variable "profiler_markup_version" does not exist.', 23, $this->source); })()))) {
                // line 24
                echo '                ';
...
';
    ...
    <span class="label ';
        ...
        ';
        // line 94
        if ((1 === (isset($context['profiler_markup_version']) || array_key_exists('profiler_markup_version', $context) ? $context['profiler_markup_version'] : (function () { throw new RuntimeError('Variable "profiler_markup_version" does not exist.', 94, $this->source); })()))) {
            // line 95
...
';
    ...
    ';
        // line 112
        if ((1 === (isset($context['profiler_markup_version']) || array_key_exists('profiler_markup_version', $context) ? $context['profiler_markup_version'] : (function () { throw new RuntimeError('Variable "profiler_markup_version" does not exist.', 112, $this->source); })()))) {
            // line 113
            echo '        <style>
            h3 { margin-top: 2em; }
    ...
    ';
        // line 132
        if (((1 === (isset($context['profiler_markup_version']) || array_key_exists('profiler_markup_version', $context) ? $context['profiler_markup_version'] : (function () { throw new RuntimeError('Variable "profiler_markup_version" does not exist.', 132, $this->source); })())) || (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 132, $this->source); })()), 'mailers', [], 'any', false, false, false, 132)) > 1))) {
            // line 133
            echo '        <table>
            <thead>
                <tr>
    ...
    ';
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['name']) {
                ...
                echo ' ';
                echo ((1 === twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 158, $this->source); })()), 'messageCount', [0 => $context['name']], 'method', false, false, false, 158))) ? ('message') : ('messages');
                echo '</span>
                </div>
            ';
            }
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", '@Swiftmailer/Collector/swiftmailer.html.twig', '/project/doyo/user-bundle/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig');
    }
}
