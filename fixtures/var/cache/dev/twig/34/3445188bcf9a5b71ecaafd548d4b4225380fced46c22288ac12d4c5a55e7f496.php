...
class __TwigTemplate_721b19ef30a30619ad45e7dce0b4a16a57c75da0073cc20da53708cc30e9b4c7 extends \Twig\Template
{
    private $source;
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo ((0 === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 38, $this->source); })()), 'totals', [], 'any', false, false, false, 38), 'calls', [], 'any', false, false, false, 38))) ? ('disabled') : ('');
        echo '">
    <span class="icon">
        ';
        // line 40
...
';
    ...
    ';
        // line 49
        if ((0 === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 49, $this->source); })()), 'totals', [], 'any', false, false, false, 49), 'calls', [], 'any', false, false, false, 49))) {
            // line 50
    ...
    ';
        ...
        <div class="sf-tabs">
            ...
            foreach ($context['_seq'] as $context['name'] => $context['calls']) {
                // line 96
                echo '                <div class="tab ';
                echo ((0 === twig_length_filter($this->env, $context['calls']))) ? ('disabled') : ('');
                echo '">
                    <h3 class="tab-title">';
                // line 97
                ...
                echo '</span></h3>
                    ...
                    <div class="tab-content">
                        ';
                // line 100
                if ((0 === twig_length_filter($this->env, $context['calls']))) {
                    // line 101
                    echo '                            <div class="empty">
...
'hit_read_ratio' === $context['key'])) {
                        ...
                        echo '                                        </span>
                                        <span class="label">';
                        // line 118
                        ((('hit_read_ratio' === $context['key'])) ? (print('Hits/reads')) : (print(twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, $context['key']), 'html', null, true))));
                        echo '</span>
                                    </div>
                                    ';
                        // line 120
                        if ((('time' === $context['key']) || ('deletes' === $context['key']))) {
                            // line 121
    ...
    {
        return [424 => 151,  416 => 148,  411 => 145,  394 => 142,  390 => 141,  386 => 140,  382 => 139,  379 => 138,  362 => 137,  347 => 124,  341 => 123,  337 => 121,  335 => 120,  330 => 118,  327 => 117,  321 => 115,  315 => 113,  313 => 112,  308 => 111,  306 => 110,  302 => 108,  298 => 107,  294 => 105,  288 => 102,  285 => 101,  283 => 100,  275 => 97,  270 => 96,  266 => 95,  255 => 87,  247 => 82,  240 => 78,  232 => 73,  225 => 69,  218 => 65,  210 => 60,  203 => 56,  199 => 54,  193 => 50,  191 => 49,  187 => 47,  178 => 46,  163 => 40,  157 => 38,  148 => 37,  135 => 33,  132 => 32,  126 => 29,  112 => 25,  105 => 21,  98 => 17,  94 => 15,  91 => 14,  84 => 10,  78 => 7,  73 => 6,  70 => 5,  67 => 4,  58 => 3,  36 => 1];
    }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", '@WebProfiler/Collector/cache.html.twig', '/project/doyo/user-bundle/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig');
    }
}
