...
class __TwigTemplate_294a2a2a4c2aa1e679bdd2d103af71ba2d7cb89f52a222636c608947fa5f28e8 extends \Twig\Template
{
    private $source;
    ...
    ';
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['log']) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context['log'], 'scream', [], 'any', true, true, false, 58) && !twig_get_attribute($this->env, $this->source, $context['log'], 'scream', [], 'any', false, false, false, 58))) {
                    ...
                    // line 62
                    echo '            ';
                } elseif (('DEBUG' === twig_get_attribute($this->env, $this->source, $context['log'], 'priorityName', [], 'any', false, false, false, 62))) {
                    // line 63
                    echo '                ';
                    ...
                    // line 66
                    echo '                ';
                    if (('INFO' !== twig_get_attribute($this->env, $this->source, $context['log'], 'priorityName', [], 'any', false, false, false, 66))) {
                        // line 67
                        echo '                    ';
...
$context['log'], 'priorityName', [], 'any', false, false, false, 205), [0 => 'CRITICAL', 1 => 'ERROR', 2 => 'ALERT', 3 => 'EMERGENCY'])) ? ('status-error') : (((('WARNING' === twig_get_attribute($this->env, $this->source,                 // line 206
$context['log'], 'priorityName', [], 'any', false, false, false, 206))) ? ('status-warning') : (''))))));
                // line 208
                echo '                <tr class="';
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", '@WebProfiler/Collector/logger.html.twig', '/project/doyo/user-bundle/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig');
    }
}
