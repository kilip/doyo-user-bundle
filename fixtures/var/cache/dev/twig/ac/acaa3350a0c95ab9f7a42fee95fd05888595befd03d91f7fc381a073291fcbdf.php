...
class __TwigTemplate_e62783f67a935c10d9dd8b7327f3308b556bba677b13fa255cf7451ecdbcaae2 extends \Twig\Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, [], \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", '@Framework/Form/form_help.html.php', '/project/doyo/user-bundle/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php');
    }
}
