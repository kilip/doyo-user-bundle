...
class __TwigTemplate_e1ea90ab8155ae2a17d3f5242e6cf959634a1ee7476446a3038a277e9bc8e995 extends \Twig\Template
{
    private $source;
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 91, $this->source); })()), 'enabled', [], 'any', false, false, false, 91)) {
            ...
            if (twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 92, $this->source); })()), 'token', [], 'any', false, false, false, 92)) {
                ...
                <div class="metric">
                    <span class="value">';
                // line 95
                ((('anon.' === twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 95, $this->source); })()), 'user', [], 'any', false, false, false, 95))) ? (print('Anonymous')) : (print(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 95, $this->source); })()), 'user', [], 'any', false, false, false, 95), 'html', null, true))));
                echo '</span>
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['decision']) {
                ...
                echo '
                        ...
                        <td>
                            ';
                // line 319
                if ((1 === twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context['decision'], 'attributes', [], 'any', false, false, false, 319)))) {
                    // line 320
                    echo '                                ';
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context['attribute'] ?? null), 'expression', [], 'any', true, true, false, 321)) {
                        ...
                        echo '</code></pre>
                                ';
                    } elseif (('string' === twig_get_attribute($this->env, $this->source,                     // line 323
(isset($context['attribute']) || array_key_exists('attribute', $context) ? $context['attribute'] : (function () { throw new RuntimeError('Variable "attribute" does not exist.', 323, $this->source); })()), 'type', [], 'any', false, false, false, 323))) {
                        // line 324
                        echo '                                    ';
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", '@Security/Collector/security.html.twig', '/project/doyo/user-bundle/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig');
    }
}
