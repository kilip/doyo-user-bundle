...
class __TwigTemplate_e975bd5b3d55db3bb1eefa3802453e3551cbc2bab6a251448266c2c137d0d81c extends \Twig\Template
{
    private $source;
...
';
    ...
    <div class="metrics">
        ...
        // line 97
        echo ((1 !== twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 97, $this->source); })()), 'fallbackLocales', [], 'any', false, false, false, 97)))) ? ('s') : ('');
        echo '</span>
        </div>
    </div>
...
';
    ...
    <div class="sf-tabs">
        <div class="tab ';
        // line 118
        echo ((0 === twig_get_attribute($this->env, $this->source, (isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 118, $this->source); })()), 'countMissings', [], 'any', false, false, false, 118))) ? ('active') : ('');
        echo '">
...
{% endmacro %}
", '@WebProfiler/Collector/translation.html.twig', '/project/doyo/user-bundle/vendor/symfony/web-profiler-bundle/Resources/views/Collector/translation.html.twig');
    }
}
