...
class GenerateJWTKeyCommand extends Command
{
    ...
    /**
     * GenerateJwtAuthKeyCommand constructor.
     *
     * @param string $pubKeyPath
     * @param string $secKeyPath
     * @param string $passphrase
     */
    public function setPath($pubKeyPath, $secKeyPath, $passphrase)
    {
    ...
    {
        $this->setName('doyo-user:generate:jwt-keys');
    }
